...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                $(\"#Nome\").hide();\n");
      out.write("                $(\"#Endereco\").hide();\n");
      out.write("              $(\"#Enviar\").click(\n");
      out.write("                function(){\n");
      out.write("                    if ($(\"#Nome:empty\") )\n");
      out.write("                        alert(\"Campo nome vazio\");\n");
      out.write("                    if ($(\"#Endereco:empty\"))\n");
      ...
      out.write("        <input type=\"text\" id=\"Endereco\" />\n");
      out.write("        <button type=\"submit\" value=\"Enviar\" id=\"Enviar\" />\n");
      out.write("    </body>\n");
      out.write("</html>\n");
    } catch (Throwable t) {
